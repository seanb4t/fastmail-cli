...
// MailboxSetBuilder builds arguments for Mailbox/set (create/update/destroy).
...
// The clientID is a temporary ID used to reference this mailbox in result references.
